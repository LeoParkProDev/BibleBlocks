...
import '../painters/pilgrim_c1_progressive_painter.dart';

class PilgrimPreviewC1Screen extends StatefulWidget {
  const PilgrimPreviewC1Screen({super.key});

  @override
  State<PilgrimPreviewC1Screen> createState() => _PilgrimPreviewC1ScreenState();
}

class _PilgrimPreviewC1ScreenState extends State<PilgrimPreviewC1Screen>
