...
import '../painters/pilgrim_c2_terrain_rising_painter.dart';

class PilgrimPreviewC2Screen extends StatefulWidget {
  const PilgrimPreviewC2Screen({super.key});

  @override
  State<PilgrimPreviewC2Screen> createState() => _PilgrimPreviewC2ScreenState();
}

class _PilgrimPreviewC2ScreenState extends State<PilgrimPreviewC2Screen>
